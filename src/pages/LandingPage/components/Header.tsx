...
function Header() {
  return (
    <section className="aurora-outer bg-gradient-to-tr from-secondary to-primary">
      <section className="aurora-center bg-gradient-to-l from-white dark:from-black to-transparent dark:to-transparent">
...
function Intro() {
  return (
    <div className="absolute top-28 left-28">
      <h1 className="my-7 font-audiowide text-[45px] text-left text-black dark:text-white">
        Introducing the next gen
        <br /> of learning PL
      </h1>
      <hr className="my-7 w-6/12 border-primary" />
      <p className="my-7 font-adventpro text-left text-lg text-primary dark:text-secondary ">
        "An intuitive platform of resourceful knowledge in tech and programming.
        <br />
        Built around the problem based approach, interactive lessons and <br />{" "}
        a well figured out user experience"
      </p>
      <button
