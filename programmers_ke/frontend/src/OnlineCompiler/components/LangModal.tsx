...
const LangModal = ({ isOpen, close, setSelectedLanguage }: LangModalProps) => {
    return (
        <>
            {isOpen ? (
                <>
                                ...
                                <div className="relative h-3/4 p-6 flex-auto dark:text-white">
                                    <ul className="flex flex-col h-full overflow-y-scroll scrollBar">
                                        {[
                                            ...
                                            { language: 'ypeScript', imgSrc: '../../../assets/icons/color_/typescript-icon-svgrepo-com.svg' },
                                            { language: 'Kotlin', imgSrc: '../../../assets/icons/color_/kotlin-svgrepo-com.svg' },
                                            { language: 'C', imgSrc: '../../../assets/icons/color_/go-svgrepo-com.svg'},
                                            ...
                                            { language: 'Go', imgSrc: '../../../assets/icons/color_/go-svgrepo-com.svg' },
                                            { language: 'Ruby', imgSrc: '../../../assets/icons/color_/ruby-svgrepo-com.svg' },
                                        ].map((item) => (
                                            <li key={item.language}>
                                                <button className="rounded-md flex flex-row justify-between align-items-center mx-auto p-3 w-full" onClick={() => setSelectedLanguage(item.language)}>
